...
<html class="no-js" lang="zxx">
    ...
    <body>
        ...
        <main>
                ...
                <div class="container">
                    <div class="row service-wrapper mt-60 justify-content-center">
                        <div class="col-xl-4  col-lg-4  col-md-4  col-sm-10 col-12">
                            <div class="single-service-content transition3 mt-10 secondary-border01 pl-50 pt-85 pb-80 pr-50 mb-30 text-center">
                                ...
                                <div class="service-text text-center">
                                    ...
                                    <ul class="service-list d-inline-block mt-1">
                                        <li class="black-color f-700  d-flex justify-content-start align-items-center">
                                            ...
                                            <a class="black-color" href="service.html">Web Design</a>
                                        </li>
                                        <li class="black-color f-700  d-flex justify-content-start align-items-center">
                                            <span class="d-inline-block pr-15 theme-color">
                                                <i class="fal fa-long-arrow-right"></i>
                                            </span>  
                                            <a class="black-color" href="service.html">Graphic Design</a>
                                        </li>
                                        <li class="black-color f-700  d-flex justify-content-start align-items-center">
                                            <span class="d-inline-block pr-15 theme-color">
                                                <i class="fal fa-long-arrow-right"></i>
                                            </span>
                                            <a class="black-color" href="service.html">Branding</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-xl-4  col-lg-4  col-md-4  col-sm-10 col-12">
                            <div class="single-service-content transition3 mt-10 secondary-border01 pl-50 pt-85 pb-80 pr-50 mb-30 text-center">
                                ...
                                <div class="service-text text-center">
                                    <h5 class="f-700 mb-25">Development</h5>
                                    <p>Ovitae purus soda duis eu ers auctor augue ultricies</p>
                        ...
                        <div class="col-xl-4  col-lg-4  col-md-4  col-sm-10 col-12">
                            <div class="single-service-content transition3 mt-10 secondary-border01 pl-50 pt-85 pb-80 pr-50 mb-30 text-center">
                                ...
                                <div class="service-text text-center">
                                    <h5 class="f-700 mb-25">Cloud Hosting</h5>
                                    <p>Ovitae purus soda duis eu ers auctor augue ultricies</p>
                        ...
                        <div class="col-xl-4  col-lg-4  col-md-4  col-sm-10 col-12">
                            <div class="single-service-content transition3 mt-10 secondary-border01 pl-50 pt-85 pb-80 pr-50 mb-30 text-center">
                                ...
                                <div class="service-text text-center">
                                    <h5 class="f-700 mb-25">Security System</h5>
                                    <p>Ovitae purus soda duis eu ers auctor augue ultricies</p>
                        ...
                        <div class="col-xl-4  col-lg-4  col-md-4  col-sm-10 col-12">
                            <div class="single-service-content transition3 mt-10 secondary-border01 pl-50 pt-85 pb-80 pr-50 mb-30 text-center">
                                ...
                                <div class="service-text text-center">
                                    <h5 class="f-700 mb-25">Photography</h5>
                                    <p>Ovitae purus soda duis eu ers auctor augue ultricies</p>
            ...
            <div class="service-cta-banner-area home3 position-relative over-hidden pt-140">
                <div class="service-cta-banner-bg bg-no-repeat"  data-background="images/bg/service-page-cta-banner-large-bg.png">
                    <div class="container">
                        <div class="row justify-content-center flex-column-reverse flex-lg-row">
                            <div class="col-xl-6 col-lg-6 offset-lg-0 col-md-10 offset-md-1 col-sm-12 col-12 d-flex justify-content-end">
                                <div class="service-cta-banner-img-wrapper-margin" data-aos="fade-up" data-aos-duration="2000">
                                    <img class="bounce-animate" src="images/feature/service-page-cta-banner-large-img.png" alt="image">
                                </div><!-- /service-cta-banner-img-wrapper -->
                            </div><!-- /col -->
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="service-cta-banner-content pt-70">
                                    <div class="title">
                                        <span class="theme-color f-700">Lets work together</span>
                                        <h3 class="f-700 mb-30">We work to make your idea visible</h3>
                                        <p class="pb-10">Phasellus seiusmod tempor incididunt ut labore et dolore mag na aliqua. Ut enim ad minim veniam</p>
                                    </div><!-- /title -->
                                    <div class="my-btn mt-47">
                                        <a href="blog-details.html" class="btn theme-bg text-capitalize f-18 f-700">lets start</a>
                                    </div><!-- /my-btn -->
                                </div><!-- /service-cta-banner-content -->
                            </div><!-- /col -->
                        </div><!-- /row -->
                    </div><!-- /container -->
                </div><!-- /service-cta-banner-bg -->
            </div>
            <!-- service-cta-banner-area -end -->


            <!-- ====== feature-area-start=========================================== -->
            <div class="feature-area feature-area4 home4 service-page pt-115 pb-150 position-relative">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-6  col-lg-7  col-md-12  col-sm-12 col-12">
                            <div class="service-content">
                                <ul class="service-text align-items-start">
                                    <li>
                                        <div class="single-service d-sm-flex mb-30">
                                    ...
                                    <li>
                                        <div class="single-service d-sm-flex mb-30">
                                         ...
                                         <div class="service-text">
                                            <h4 class="f-700 pb-15">Top Quality Service</h4>
                                            <p>Ovitae purus soda duis eu ers auctor augue ultricie iam, quis nostrud exercitation ullamco laboris nisi ut aliquip.</p>
                                         </div>
                                        </div><!-- /single-service -->
                                    </li>
            ...
            <!-- ====== faq-area-start============================================ -->
            <div class="faq-service-page-area primary-bg pt-155 pb-120 over-hidden">
                <div class="container">
                    ...
                    <div class="row faq-wrapper mt-35">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="single-faq mb-45">
                                <h5 class="f-700 mb-20">Why Evalo is so popular in marketplace?</h5>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="single-faq mb-45">
                                <h5 class="f-700 mb-20">What is the best way to customize Evalo?</h5>
                                <p>Ovitae purus soda duis eu ers auctor augue ultricie iam, quis nostrud exercitation ullamco laboris nisi ut aliq do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </div>
                        </div><!-- /col -->
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="single-faq mb-45">
                                <h5 class="f-700 mb-20">What is the refund policy in Evalo?</h5>
                                <p>Ovitae purus soda duis eu ers auctor augue ultricie iam, quis nostrud exercitation ullamco laboris nisi ut aliq do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </div>
                        </div><!-- /col -->
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-8  col-lg-9  col-md-8  col-sm-12 col-12">
                            <div class="title text-center mt-20">
                                ...
                                <p class="mb-1">Bole nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo conididunt ut labore et dolore magna aliqua ut enim ad minim veniam</p>
                            </div><!-- /title -->
                        </div><!-- /col -->
                    </div><!-- /row -->
                                ...
                                <div class="testimonial-content position-relative mt-1">
                                    ...
                                    <div class="testimonial-active">
                                        <div class="testimonial-text pb-25">
                                            <p class="font-italic secondary-color3">Olireipum dolor sit amet, consectetur adipisicing elit, sed do eius mod tempor incididunt ut labore et dolore magna aliqu Lor em ipsum dolor sit amet, consecte tur adipisicing elit, sed do eiusmod tempor</p>
                                ...
                                <div class="col-xl-6  col-lg-6  col-md-6  col-sm-12 col-12">
                                    <div class="copyright-text text-center text-md-left mt-20 mb-20">
                                        <p class="mb-0 secondary-color2">All rights reserved 
                                            <a href="https://themeforest.net/user/ethemestudio/portfolio" class="c-theme f-700 black-color">eThemeStudio</a>  ©  2022
                                        </p>
                                    </div>
                                </div><!-- /col -->
                                <div class="col-xl-6  col-lg-6  col-md-6  col-sm-12 col-12 ">
