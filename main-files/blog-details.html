...
<html class="no-js" lang="zxx">
    ...
    <body>
        ...
        <!--  ====== header-area-start=======================================  -->
        <header>
            <div id="header-sticky" class="transparent-header black-header blog-overly-header home6 header-area">
                <div class="header">
                    <div class="container">
                        <div class="row align-items-center justify-content-between position-relative">
                            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-6">
                                <div class="logo">
                                    <a href="index.html" class="d-inline-block"><img src="images/logo/logo-white.png" alt="Evalo"></a>
                                </div>
                            </div><!-- /col -->
                            ...
                            <div class="col-xl-3  col-lg-3 col-md-6 col-sm-6 col-4">
                                <div class="header-right d-flex align-items-center justify-content-end">
                                    <div class="my-btn d-none d-md-block d-none">
                                        <a href="contact-us.html" class="btn transparent-bg text-white text-capitalize">Get A Quote</a>
                                    </div><!-- /my-btn -->
