                                        ...
                                        <div class="accordion" id="accordion-tab-1">
                                            ...
                                            <div class="card border-0">
                                                <div class="card-header bg-transparent border-bottom-0 p-0" id="accordion-tab-1-heading-3">
                                                    <h6 class="mb-0">
                                                        <a href="#" class="btn btn-link black-color f-700 d-block text-left rounded-0 position-relative collapsed" data-toggle="collapse" data-target="#accordion-tab-1-content-3" aria-expanded="false" aria-controls="accordion-tab-1-content-3">Why Evalo is a great startup template?</a>
                                                    </h6>
                                                </div>
                                            ...
                                            <div class="card border-0">
                                                <div class="card-header bg-transparent border-bottom-0 p-0" id="accordion-tab-1-heading-4">
                                                    <h6 class="mb-0">
                                                        <a href="#" class="btn btn-link black-color f-700 d-block text-left rounded-0 position-relative collapsed" data-toggle="collapse" data-target="#accordion-tab-1-content-4" aria-expanded="false" aria-controls="accordion-tab-1-content-4">How to get the best output from Evalo?</a>
                                                    </h6>
                                                </div>
                                            ...
                                            <div class="card border-0">
                                                <div class="card-header bg-transparent border-bottom-0 p-0" id="accordion-tab-1-heading-5">
                                                    <h6 class="mb-0">
                                                        <a href="#" class="btn btn-link black-color border-bottom-0 f-700 d-block text-left rounded-0 position-relative collapsed" data-toggle="collapse" data-target="#accordion-tab-1-content-5" aria-expanded="false" aria-controls="accordion-tab-1-content-5">What is the proper way to customize Evalo?</a>
                                                    </h6>
                                                </div>
